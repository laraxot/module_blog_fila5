---
title: "Second Brain Local Discipline (stub Blog)"
type: concept
module: Blog
tags: [second-brain, stub, hackernoon, harness]
created: 2026-06-05
updated: 2026-06-05
qmd: "blog second brain stub canonical xot harness hackernoon llm-wiki"
issues:
...
# Contratto wiki locale — stub Blog
...
Solo decisioni specifiche di **Blog** in `docs/wiki/`; contratto generico in Xot.
